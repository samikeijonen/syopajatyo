...
function maybe_wrap_embed( $html, $url ) {
	...
	$patterns = apply_filters( 'syopajatyo_maybe_wrap_embed_patterns', $patterns ); // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedHooknameFound
