...
<form role="search" method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	...
	<button type="submit" class="search-form__submit"><?php Syopajatyo\display_svg( [ 'icon' => 'search' ] ); ?><span class="screen-reader-text"><?php echo esc_attr_x( 'Search', 'submit button', 'syopajatyo' ); ?></span></button>
</form>
